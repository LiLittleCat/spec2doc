...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({
        spacing: { after: 120 },
        children: [new TextRun("本文档描述系统数据库的设计方案，包括数据表结构、字段定义、索引设计、关系说明等内容。")]
      }),
          ...
          new TableRow({
            children: [
              new TableCell({
                ...
                children: [new Paragraph({ children: [new TextRun({ text: "数据库名称", bold: true })] })]
              }),
              new TableCell({
                borders: cellBorders,
          ...
          new TableRow({
            children: [
              new TableCell({
                ...
                width: { size: 2340, type: WidthType.DXA },
                shading: { fill: "F2F2F2", type: ShadingType.CLEAR },
                children: [new Paragraph({ children: [new TextRun({ text: "数据库类型", bold: true })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 7020, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun("【MySQL / PostgreSQL / Oracle / SQL Server】")] })]
              })
            ]
          }),
          new TableRow({
            children: [
              new TableCell({
                ...
                width: { size: 2340, type: WidthType.DXA },
                shading: { fill: "F2F2F2", type: ShadingType.CLEAR },
                children: [new Paragraph({ children: [new TextRun({ text: "数据库版本", bold: true })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 7020, type: WidthType.DXA },
          ...
          new TableRow({
            children: [
              new TableCell({
                ...
                width: { size: 2340, type: WidthType.DXA },
                shading: { fill: "F2F2F2", type: ShadingType.CLEAR },
                children: [new Paragraph({ children: [new TextRun({ text: "字符集", bold: true })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 7020, type: WidthType.DXA },
          ...
          new TableRow({
            children: [
              new TableCell({
                ...
                width: { size: 2340, type: WidthType.DXA },
                shading: { fill: "F2F2F2", type: ShadingType.CLEAR },
                children: [new Paragraph({ children: [new TextRun({ text: "排序规则", bold: true })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 7020, type: WidthType.DXA },
          ...
          new TableRow({
            children: [
              new TableCell({
                ...
                width: { size: 2340, type: WidthType.DXA },
                shading: { fill: "F2F2F2", type: ShadingType.CLEAR },
                children: [new Paragraph({ children: [new TextRun({ text: "存储引擎", bold: true })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 7020, type: WidthType.DXA },
          ...
          new TableRow({
            children: [
              new TableCell({
                ...
                width: { size: 2340, type: WidthType.DXA },
                shading: { fill: "F2F2F2", type: ShadingType.CLEAR },
                children: [new Paragraph({ children: [new TextRun({ text: "表注释", bold: true })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 7020, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun("【表功能说明，如：用户信息表】")] })]
              })
            ]
          }),
          new TableRow({
          ...
          new TableRow({
            ...
            children: [
              ...
              new TableCell({
                ...
                children: [new Paragraph({
                  alignment: AlignmentType.CENTER,
                  children: [new TextRun({ text: "长度", bold: true, color: "FFFFFF", size: 20 })]
                })]
              }),
              new TableCell({
                borders: cellBorders,
          ...
          new TableRow({
            children: [
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 1170, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun({ text: "BIGINT", size: 20 })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 936, type: WidthType.DXA },
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 936, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "否", size: 20 })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 702, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "是", size: 20 })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 702, type: WidthType.DXA },
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 936, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "AUTO", size: 20 })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 2214, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun({ text: "主键ID，自增", size: 20 })] })]
              })
            ]
          }),
          new TableRow({
            children: [
              new TableCell({
                borders: cellBorders,
                width: { size: 1404, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun({ text: "【字段名】", size: 20 })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 1170, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun({ text: "【类型】", size: 20 })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 936, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "【长度】", size: 20 })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 936, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "【是/否】", size: 20 })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 702, type: WidthType.DXA },
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 936, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "【值】", size: 20 })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 2214, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun({ text: "【说明】", size: 20 })] })]
              })
            ]
          }),
          new TableRow({
            children: [
              new TableCell({
                borders: cellBorders,
                width: { size: 1404, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun({ text: "create_time", size: 20 })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 1170, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun({ text: "DATETIME", size: 20 })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 936, type: WidthType.DXA },
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 936, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "NOW()", size: 20 })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 2214, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun({ text: "创建时间", size: 20 })] })]
              })
            ]
          }),
          new TableRow({
            children: [
              new TableCell({
                borders: cellBorders,
                width: { size: 1404, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun({ text: "update_time", size: 20 })] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 1170, type: WidthType.DXA },
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 2214, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun({ text: "更新时间", size: 20 })] })]
              })
            ]
          })
        ]
          ...
          new TableRow({
            children: [
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 1872, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun("主键索引")] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 1872, type: WidthType.DXA },
          ...
          new TableRow({
            children: [
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 1872, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun("【普通/唯一/全文】")] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 1872, type: WidthType.DXA },
          ...
          new TableRow({
            children: [
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 2340, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun("【枚举值】")] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 4680, type: WidthType.DXA },
          ...
          new TableRow({
            children: [
              new TableCell({
                borders: cellBorders,
                width: { size: 1872, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun("V1.0.0")] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 1872, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun("【日期】")] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 1872, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun("【姓名】")] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 3744, type: WidthType.DXA },
          ...
          new TableRow({
            children: [
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 7020, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun("可变长度字符串，n为最大长度")] })]
              })
            ]
          }),
          new TableRow({
          ...
          new TableRow({
            children: [
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 7020, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun("日期时间，格式：YYYY-MM-DD HH:MM:SS")] })]
              })
            ]
          }),
          new TableRow({
            children: [
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 7020, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun("定点数，m为总位数，d为小数位数，常用于金额")] })]
              })
            ]
          }),
          new TableRow({
            children: [
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 7020, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun("小整数（-128到127），常用于状态字段")] })]
              })
            ]
          })
        ]
