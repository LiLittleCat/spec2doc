...
const children = [
  ...
  new Paragraph({
    ...
    children: [
      new TextRun({ text: `版本：${openApiSpec.info.version}`, size: 24, color: "666666" }),
    ],
  }),
      ...
      new TableRow({
        children: [
          ...
          new TableCell({
            ...
            width: { size: 7020, type: WidthType.DXA },
            children: [
              new Paragraph({ children: [new TextRun(openApiSpec.servers?.[0]?.url || "N/A")] }),
            ],
          }),
        ],
      }),
      ...
      new TableRow({
        children: [
          ...
          new TableCell({
            ...
            width: { size: 7020, type: WidthType.DXA },
            children: [
              new Paragraph({ children: [new TextRun(new Date().toLocaleDateString("zh-CN"))] }),
            ],
          }),
        ],
      }),
          ...
          new TableRow({
            children: [
              new TableCell({
                ...
                shading: { fill: "F2F2F2", type: ShadingType.CLEAR },
                children: [
                  new Paragraph({ children: [new TextRun({ text: "Content-Type", bold: true })] }),
                ],
              }),
              new TableCell({
                borders: cellBorders,
          ...
          new TableRow({
            children: [
              ...
              new TableCell({
                ...
                children: [
                  new Paragraph({
                    children: [new TextRun(operation.description || operation.summary)],
                  }),
                ],
              }),
            ],
          ...
          new TableRow({
            children: [
              ...
              new TableCell({
                ...
                children: [
                  new Paragraph({
                    children: [new TextRun(param.example || param.schema?.example || "")],
                  }),
                ],
              }),
              new TableCell({
            ...
            new TableRow({
              children: [
                ...
                new TableCell({
                  ...
                  width: { size: 1404, type: WidthType.DXA },
                  children: [
                    new Paragraph({ children: [new TextRun(String(field.example || ""))] }),
                  ],
                }),
                new TableCell({
                  borders: cellBorders,
