...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({
        spacing: { after: 120 },
        children: [new TextRun("本文档描述系统提供的API接口规范，包括接口地址、请求参数、响应数据等详细信息。")]
      }),
          ...
          new TableRow({
            children: [
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 7020, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun("【GET / POST / PUT / DELETE】")] })]
              })
            ]
          }),
          new TableRow({
          ...
          new TableRow({
            children: [
              ...
              new TableCell({
                borders: cellBorders,
                width: { size: 1170, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun("【是/否】")] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 1404, type: WidthType.DXA },
          ...
          new TableRow({
            children: [
              new TableCell({
                borders: cellBorders,
                width: { size: 1872, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun("400")] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 7488, type: WidthType.DXA },
          ...
          new TableRow({
            children: [
              new TableCell({
                borders: cellBorders,
                width: { size: 1872, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun("401")] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 7488, type: WidthType.DXA },
                children: [new Paragraph({ children: [new TextRun("未授权，Token无效或已过期")] })]
              })
            ]
          }),
          new TableRow({
            children: [
              new TableCell({
                borders: cellBorders,
                width: { size: 1872, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun("403")] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 7488, type: WidthType.DXA },
          ...
          new TableRow({
            children: [
              new TableCell({
                borders: cellBorders,
                width: { size: 1872, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun("500")] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 7488, type: WidthType.DXA },
          ...
          new TableRow({
            children: [
              new TableCell({
                borders: cellBorders,
                width: { size: 1872, type: WidthType.DXA },
                children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun("【错误码】")] })]
              }),
              new TableCell({
                borders: cellBorders,
                width: { size: 7488, type: WidthType.DXA },
